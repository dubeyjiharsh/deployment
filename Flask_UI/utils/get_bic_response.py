...
def get_bic_response(session_id):
    """
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.execute("SELECT id, user_name, request_number, submitted_date, last_updated, status FROM submissions WHERE session_id = %s", (session_id,))
