...
IMPORTANT: The "metric" should be a brief label (2-5 words), NOT the full success statement. The "target" should be the measurable goal, NOT a repeat of the metric.`,
    ...
    // === GOVERNANCE ===
  {
    ...
    valueType: "object" as const,
    instructions:
      'Extract governance structure from documents. Output MUST be an object with two arrays: "approvers" and "reviewers". Each person in both arrays MUST have: "role" (job title like "Digital Product Director"), "name" (what they oversee), "function" (what they have final say on). The rendered output displays two sections with headings "**Approvers**" and "**Reviewers**", each followed by bullet points formatted as "• **Role** - name (function: function description)".',
    examples:
      '{"approvers": [{"role": "Digital Product Director", "name": "Overall solution architecture and user experience design", "function": "Final approval on product requirements and launch readiness"}, {"role": "Brand Marketing Director", "name": "Campaign integration and brand consistency", "function": "Creative asset approval and editorial content strategy"}, {"role": "Technology Architecture Lead", "name": "Technical implementation and infrastructure decisions", "function": "System integration and performance standards"}], "reviewers": [{"role": "Digital Product Director", "name": "Overall solution architecture and user experience design", "function": "Final approval on product requirements and launch readiness"}, {"role": "Brand Marketing Director", "name": "Campaign integration and brand consistency", "function": "Creative asset approval and editorial content strategy"}, {"role": "Technology Architecture Lead", "name": "Technical implementation and infrastructure decisions", "function": "System integration and performance standards"}]}',
    negativePrompt:
